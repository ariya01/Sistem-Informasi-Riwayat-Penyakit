...
<div class="col-12">
  ...
  <div class="card-body">
    ...
    <form class="forms-sample" method="post" action="{{url('kirim3')}} ">
      ...
      <div class="form-group">
        <label for="exampleInputPassword1">Keterangan Alergi</label>
        <div class="input-group">
          <div class="input-group-prepend">
          </div>
...
@if ($data!=null)
<input type="hidden" name="id" id="id" value="{{$data->id_alergi}}">
@endif
@endsection
@section('js')
<script type="text/javascript">
            ...
            if(bla)
            {
              $.ajax({    
                ...
                success:function(data){
                  ...
                  $("#nama").val(JSON.parse(data).nama_alergi);
                  $("#ket").val(JSON.parse(data).keterangan);
                  $('#id_alergi').val(JSON.parse(data).id_alergi);
                },
                error:function(data){
