...
<div class="col-12">
  <div  class="card">
      ...
      <span style="font-size: 80%;"> Kembali Obat </span>
    </a>
  <div class="card-body">
    <h4 class="card-title">Obat</h4>
    <form class="forms-sample" method="post" action="{{url('editobatnya')}} ">
            ...
            if(bla)
            {
              $.ajax({    
                ...
                success:function(data){
                  ...
                  $("#nama").val(JSON.parse(data).nama_obat);
                  $("#ket").val(JSON.parse(data).ket_obat);
                  $('#id_obat').val(JSON.parse(data).id_obat);
                },
                error:function(data){
